...
{
f.open("/home/neha/Miniproject/Store.txt",ios::out|ios::app);
s.AddProduct();
...
system("clear");
cout<<"\n\n\n\t\tDISPLAY ALL RECORD !!!\n\n";
f.open("home/neha/Miniproject/Store.txt",ios::in);
int flag;
flag=0;
while(flag==0)
{
...
cout<<"\n\n\tEnter The Item No. of The Product";
cin>>no;
f.open("home/neha/Miniproject/Store.txt",ios::in|ios::out);
...
f.open("home/neha/Miniproject/Store.txt",ios::in|ios::out);
fstream f2;
f2.open("home/neha/Miniproject/Temp.txt",ios::out);
f.seekg(0,ios::beg);
while(f.read((char*)&s,sizeof(supermarket)))
{
if(s.itemno!=no)
...
f2.close();
f.close();
remove("home/neha/Miniproject/Store.txt");
rename("home/neha/Miniproject/Temp.txt","home/neha/Miniproject/Store.txt");
cout<<"\n\n\tRecord Deleted ..";
}
